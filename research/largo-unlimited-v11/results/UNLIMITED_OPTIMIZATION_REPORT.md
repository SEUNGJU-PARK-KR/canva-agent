...
| 정책 | 거래일 | 종목 편입 | 승 | 패 | 승률 | 누적 복리 | 최대 낙폭 | 주 2일 충족률 |
|---|---|---|---|---|---|---|---|---|
| 수익·승률 균형안 | 94 | 94 | 71 | 23 | 75.5% | -23.18% | -31.44% | 100.0% |
| 승률 우선안 | 94 | 94 | 73 | 21 | 77.7% | -13.09% | -38.49% | 100.0% |
| 수익 우선안 | 94 | 94 | 66 | 28 | 70.2% | -29.12% | -34.16% | 100.0% |
| 같은 계산기·주 2일 상한 | 86 | 86 | 63 | 23 | 73.3% | +49.86% | -30.11% | 100.0% |
| 같은 계산기·상한만 제거 | 203 | 203 | 149 | 54 | 73.4% | +49.37% | -47.12% | 100.0% |
...
후속 우선 후보 거래일은 51일, 예외 보충은 43일입니다. 비교 가능한 주는 42주이며 42주가 최소 2신호일을 충족했습니다. 휴장 한 거래일 주와 구간 경계가 잘린 주는 분모에서 제외했습니다.
...
| 신호 월 | 거래일 | 종목 편입 | 승 | 패 | 승률 | 월 복리 | 월 낙폭 |
|---|---|---|---|---|---|---|---|
| 2025-07 | 10 | 10 | 8 | 2 | 80.0% | +6.12% | -1.73% |
| 2025-08 | 11 | 11 | 7 | 4 | 63.6% | -18.95% | -21.66% |
| 2025-09 | 9 | 9 | 6 | 3 | 66.7% | -7.18% | -12.80% |
| 2025-10 | 11 | 11 | 9 | 2 | 81.8% | +26.67% | -2.48% |
| 2025-11 | 8 | 8 | 6 | 2 | 75.0% | -1.44% | -3.97% |
| 2025-12 | 10 | 10 | 7 | 3 | 70.0% | -20.88% | -29.14% |
| 2026-01 | 9 | 9 | 8 | 1 | 88.9% | +3.54% | -8.03% |
| 2026-02 | 8 | 8 | 7 | 1 | 87.5% | +1.83% | -10.29% |
| 2026-03 | 8 | 8 | 7 | 1 | 87.5% | +4.42% | -5.36% |
| 2026-04 | 10 | 10 | 6 | 4 | 60.0% | -11.53% | -25.13% |
...
| 가정 | 거래일 | 승률 | 누적 복리 | 최대 낙폭 |
|---|---|---|---|---|
| base | 94 | 75.5% | -23.18% | -31.44% |
| cost0.5 | 94 | 75.5% | -36.41% | -39.03% |
| cost1.0 | 94 | 29.8% | -60.41% | -60.65% |
| cap_open_gain_at_target | 94 | 75.5% | -66.29% | -66.74% |
| half_exposure | 94 | 75.5% | -9.97% | -15.85% |
| optimistic_touch_order | 94 | 75.5% | -23.18% | -31.44% |
| same_stocks_open_exit | 94 | 36.2% | -36.06% | -37.38% |
| best_3_days_removed | 94 | 72.3% | -45.91% | -49.26% |
| best_5_days_removed | 94 | 70.2% | -52.18% | -55.14% |
...
이익으로 마친 종목 중 다음 날 하루 저가가 -3% 이했던 사례는 31건입니다. 이 반등이 09:06 전에 발생했는지 알 수 없습니다.
...
15,984개 설정을 2024년 개발 구간에서 비교했습니다. 개발 상위 47개를 2025년 상반기에서 비교한 뒤 균형·승률우선·수익우선안을 고정했습니다. 후속 수익으로 설정을 다시 바꾸지 않았습니다.
...
주 단위 2,000회 재표집한 거래일 승률 95% 구간은 [0.6666666666666666, 0.8391140865737342], 거래일 평균수익 구간은 [-1.248390776016967, 0.8787002319953897]%입니다. 반복 탐색과 자료 편향을 모두 교정한 예측구간은 아닙니다.

개발을 포함한 2024-01~2026-04 전체 균형안은 256거래일, 승률 77.3%, 복리 +46.19%, 최대 낙폭 -35.89%입니다. 개발 구간 포함 숫자를 독립 성과로 쓰지 않습니다.
